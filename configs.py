...
class Config(object):
	API_ID = 17833358
        ...
        BOT_TOKEN = "7654083045:AAHmCyWZqy4rOQMjQBrceryt3N3uh59rGu4"
        BOT_USERNAME = "kuttyfilestorebot"
        DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002105619071"))
        BOT_OWNER = int(os.environ.get("BOT_OWNER", "5691291380"))
        DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Itachi:15@itachiuchicha.3nsc8.mongodb.net/?retryWrites=true&w=majority")
